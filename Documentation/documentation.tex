...
The project aims to create a demonstrator of the use of static analysis tools for web applications. The web application used 
for this puprose is based on a React front-end and an Express back-end. It is an application which allows to sellers to receive
payments from users which have a wallet that can be recharged. There is also the admin who is able to view and modify the 
transactions and to register the sellers.  
...
\textbf{Vulnerable code:} In \texttt{authentication.js} (server), lines 72-121:
\begin{lstlisting}
