...
\hline
Unencrypted request over HTTP detected (TP) & \cmark & & \cmark \\ 
\hline
Missing Helmet configuration on HTTP headers (TP) & & \cmark & \\ 
\hline
Missing server configuration to reduce server fingerprinting (TP) & & \cmark & \\ 
\hline
Leakage of information in logger message (TP) & & \cmark & \\ 
\hline
Code string concatenation (TP) & \cmark & & \\ 
\hline
Weak symmetric mode (TP) & \cmark & & \\ 
\hline
Incomplete sanitization (TP) & \cmark & & \cmark \\ 
\hline
eval() function detected (TP) & \cmark & & \cmark \\ 
\hline
Unsanitized dynamic input in file path (TP) & & \cmark & \\ 
\hline
React dangerouslySetInnerHTML (TP) & \cmark & \cmark & \cmark \\ 
\hline
Unsanitized user input in deserialization method (TP) & \cmark & \cmark & \cmark \\ 
\hline
Express cookie session default name (TP) & \cmark & & \cmark \\ 
\hline
Express cookie session no secure (TP) & \cmark & \cmark & \cmark \\ 
\hline
Express cookie session no httponly (TP) & \cmark & \cmark & \cmark \\ 
\hline
Express cookie session no domain (TP) & \cmark & & \cmark \\ 
\hline
Express cookie session no path (TP) & \cmark & & \cmark \\ 
\hline
Express cookie session no expires (TP) & \cmark & & \cmark \\ 
\hline
Express check directory listing (TP) & \cmark & \cmark & \cmark \\ 
\hline
Express check csurf middleware usage (TP) & \cmark & & \cmark \\ 
\hline
Unsanitized input in NoSQL query (TP) & & \cmark & \\ 
\hline
Usage of default cookie configuration (TP) & & \cmark & \\ 
\hline
Usage of default session cookie configuration (TP) & & \cmark & \\ 
\hline
Observable Timing Discrepancy (FP) & & \cmark & \\ 
\hline
\end{tabular}
\end{center}
